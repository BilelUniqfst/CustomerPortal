              ...
              <div class="content">
                ...
                <form class="login-form" method="post">
                  <div class="row">
                    <div class="col-lg-12 col-md-12">
                      <div class="form-group">
                        <i class="fas fa-envelope-open"></i> <input name="userName" class="form-control"
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12">
                      <div class="form-group">
                        <i class="fas fa-lock"></i> <input name="userPassword" class="form-control"
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="row">
                      <button type="submit" name="login" value="Next">
                        Login
                      </button>
                    </div>
                  </div>
